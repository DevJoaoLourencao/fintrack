        ...
        <div className="rounded-xl border border-border bg-card divide-y divide-border">
          {filtered.map((v) => (
            <div key={v.id} className="px-4 py-3">
               ...
               * flex-wrap causes the info block (w-full sm:w-auto) to occupy
               * its own row on narrow screens, then the actions row follows.
               */}
              <div className="flex flex-wrap items-center gap-x-3 gap-y-2">

                {/* Info — full width on mobile, grows on desktop */}
                ...
                {/*
                 * Actions — full width on mobile (justify-between spreads price
                 * to the left and buttons to the right), auto width on desktop.
                 */}
                <div className="flex w-full sm:w-auto items-center justify-between sm:justify-normal gap-2">
